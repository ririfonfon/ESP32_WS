    ...
    for (int i = 0; i < n_led_to_show ; i ++) {
      ...
      if (n_strip == 0) {
        ...
        if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S) {
          ...
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), N_L_P_S + 1, N_L_P_S * 2, N_L_P_S, 0);
          strands[1]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * str * master / 255), (pi_n_0_g[di] * str * master / 255), (pi_n_0_b[di] * str * master / 255));
        } else if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S * 3 & a - (NUM_LEDS_PER_STRIP * n_strip >= N_L_P_S * 2)) {
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), (N_L_P_S * 2) + 1, N_L_P_S * 3, 0, N_L_P_S);
          strands[1]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * str * master / 255), (pi_n_0_g[di] * str * master / 255), (pi_n_0_b[di] * str * master / 255));
        }
        ...
        if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S) {
          ...
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), N_L_P_S + 1, N_L_P_S * 2, N_L_P_S, 0);
          strands[2]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * str * master / 255), (pi_n_0_g[di] * str * master / 255), (pi_n_0_b[di] * str * master / 255));
        } else if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S * 3 & a - (NUM_LEDS_PER_STRIP * n_strip >= N_L_P_S * 2)) {
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), (N_L_P_S * 2) + 1, N_L_P_S * 3, 0, N_L_P_S);
          strands[2]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * str * master / 255), (pi_n_0_g[di] * str * master / 255), (pi_n_0_b[di] * str * master / 255));
        }
        ...
        if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S) {
          ...
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), N_L_P_S + 1, N_L_P_S * 2, N_L_P_S, 0);
          strands[3]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * str * master / 255), (pi_n_0_g[di] * str * master / 255), (pi_n_0_b[di] * str * master / 255));
        } else if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S * 3 & a - (NUM_LEDS_PER_STRIP * n_strip >= N_L_P_S * 2)) {
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), (N_L_P_S * 2) + 1, N_L_P_S * 3, 0, N_L_P_S);
          strands[3]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * str * master / 255), (pi_n_0_g[di] * str * master / 255), (pi_n_0_b[di] * str * master / 255));
        }
    ...
    for (int i = 0; i < n_led_to_show ; i ++) {
      ...
      if (n_strip == 0) {
        ...
        if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S) {
          ...
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), N_L_P_S + 1, N_L_P_S * 2, N_L_P_S, 0);
          strands[1]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * master / 255), (pi_n_0_g[di] * master / 255), (pi_n_0_b[di] * master / 255));
        } else if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S * 3 & a - (NUM_LEDS_PER_STRIP * n_strip >= N_L_P_S * 2)) {
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), (N_L_P_S * 2) + 1, N_L_P_S * 3, 0, N_L_P_S);
          strands[1]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * master / 255), (pi_n_0_g[di] * master / 255), (pi_n_0_b[di] * master / 255));
        }
        ...
        if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S) {
          ...
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), N_L_P_S + 1, N_L_P_S * 2, N_L_P_S, 0);
          strands[2]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * master / 255), (pi_n_0_g[di] * master / 255), (pi_n_0_b[di] * master / 255));
        } else if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S * 3 & a - (NUM_LEDS_PER_STRIP * n_strip >= N_L_P_S * 2)) {
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), (N_L_P_S * 2) + 1, N_L_P_S * 3, 0, N_L_P_S);
          strands[2]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * master / 255), (pi_n_0_g[di] * master / 255), (pi_n_0_b[di] * master / 255));
        }
        ...
        if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S) {
          ...
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), N_L_P_S + 1, N_L_P_S * 2, N_L_P_S, 0);
          strands[3]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * master / 255), (pi_n_0_g[di] * master / 255), (pi_n_0_b[di] * master / 255));
        } else if (a - (NUM_LEDS_PER_STRIP * n_strip) <= N_L_P_S * 3 & a - (NUM_LEDS_PER_STRIP * n_strip >= N_L_P_S * 2)) {
          int di = map(a - (NUM_LEDS_PER_STRIP * n_strip), (N_L_P_S * 2) + 1, N_L_P_S * 3, 0, N_L_P_S);
          strands[3]->pixels[a - (NUM_LEDS_PER_STRIP * n_strip)] = pixelFromRGB((pi_n_0_r[di] * master / 255), (pi_n_0_g[di] * master / 255), (pi_n_0_b[di] * master / 255));
        }
