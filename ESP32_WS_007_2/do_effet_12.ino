void do_effet_12() {
  if (_Pix_mod == 0) {
    ...
    for (int i = 0 ; i < NUM_LEDS_PER_STRIP ; i++) {
      ...
      pix_buffer[0][ci].r = (( rrr * rrr / 255 )  * rr) / 255;
      pix_buffer[0][ci].g = (( ggg * ggg / 255 )  * gg) / 255;
      pix_buffer[0][ci].b = (( bbb * bbb / 255 )  * bb) / 255;
      pix_buffer[1][ci].r = (( rrr * rrr / 255 )  * rr) / 255;
      pix_buffer[1][ci].g = (( ggg * ggg / 255 )  * gg) / 255;
      pix_buffer[1][ci].b = (( bbb * bbb / 255 )  * bb) / 255;
      pix_buffer[2][ci].r = (( rrr * rrr / 255 )  * rr) / 255;
      pix_buffer[2][ci].g = (( ggg * ggg / 255 )  * gg) / 255;
      pix_buffer[2][ci].b = (( bbb * bbb / 255 )  * bb) / 255;
      pix_buffer[3][ci].r = (( rrr * rrr / 255 )  * rr) / 255;
      pix_buffer[3][ci].g = (( ggg * ggg / 255 )  * gg) / 255;
      pix_buffer[3][ci].b = (( bbb * bbb / 255 )  * bb) / 255;
